            ...
            <div class="row">
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="name" id="nama" placeholder="" required value="{{ old('name') }}">
                    </div>
                </div>
                <div class="col-12">
                    <div class="form-group">
                        <label for="point">Point</label>
                        <input type="number" class="form-control" name="point" id="point" placeholder="" required value="{{ old('point') }}">
                    </div>
                </div>
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <select name="type" id="type" class="form-control" required>
                            ...
                            <option value="{{ $Waste::VALUABLE }}">Berharga</option>
                            <option value="{{ $Waste::WORTHLESS }}">Tidak Berharga</option>
                        </select>
                    </div>
                </div>
                <div class="col-12">
