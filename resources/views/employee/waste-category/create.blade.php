...
@section('page-content')
    <section>
        <form action="{{ route('waste_category.index') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-12">
                    <div class="form-group">
                        <label for="code">Code</label>
                        <input type="text" class="form-control" name="code" id="code" placeholder="judul" required value="{{ old('code') }}">
                    </div>
                </div>
                <div class="col-12">
                    <div class="form-group">
