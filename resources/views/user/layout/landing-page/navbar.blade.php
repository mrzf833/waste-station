<div>
    ...
    <div class="navbar absolute right-0 mx-14 font-semibold my-5">
        ...
        <a href="{{ route('landing.information_education') }}" class="text-xl mx-3 link-navbar {{ request()->routeIs('landing.information_education*') ? 'link-navbar-active' : '' }}">Informasi edukasi</a>
